...
# Load the processed trade statistics data
processedTradeStats <- readRDS(file.path(repository, "data", "secure", "processed_trade_stats.rds"))
...
# Calculate ECO 1.4.1 Value and volume of international trade/merchandise trade (proxy- NSDP indicator is for national)
...
# Calculate ECO 1.5.2 Trade by trade agreement (proxy- all imports too MSG countries)
...
# Calculate ECO 1.6.2 Total estimated value of trade agreement as a proportion of GDP
timeSeriesGrossDomesticProduct <- data.frame("2006"=48611000000, "2007"=52898000000, "2008"=59863000000, "2009"=63257000000, "2010"=64996000000, "2011"=68905000000, "2012"=69278000000, "2013"=71692000000, "2014"=74970000000, "2015"=79657000000, "2016"=84707000000, "2017"=94887000000, "2018"=100771000000) # Insert values into table
mostRecentGrossDomesticProduct<- timeSeriesGrossDomesticProduct[1, 13] #need to change to takes subset of last value for when GDP figures are added
...
nsdpIndicators <- data.frame( # Inserted NAs here as the number of rows in each column must match
  "Policy Objectives"=c("ECO 1.4: Increase trade and investment opportunities and reduce barriers, including through the use of Aid-for-Trade",
                        "ECO 1.5: Increase access to markets for Vanuatu exports", # Exact copies here in each row as these cels will be merged
...
# Trade Balance of Top 5 Pacific Islands (excluding Melanesian Islands, Australia and New Zealand) 
